...
import axiosMethods from "../../axios/authaxiosinstance";
...
function Home(props) {
  ...
  useEffect(() => {
    function authenticationPage() {
      ...
      check !== null ? setAuthenticated(true) : setAuthenticated(false);
      //check !== null ? console.log("Authenticated") : navigate("/");
      // if (check !== null) {
  ...
  const getUserInfo = async () => {
    ...
    let res = await axiosMethods.get(endpoint.GET_USER_INFO);
    console.log("Res: ", res);
